...
|----------|---------|------|--------|
| `/path/to/zolai/Downloads/Kaggle/` | Kaggle notebooks + scripts + data | ~2GB | Active (Kaggle-first) |
| `/path/to/zolai-toolkit/` | Python package + GUI + API | ~17.5GB | Active (local-first) |
...
```
/path/to/zolai/          # NEW unified root
...
```bash
mkdir -p /path/to/zolai/{src/zolai,notebooks,scripts,data/{raw/{bibles,tongdot,tongsan},processed/{bible,dictionary,corpus,grammar},training/{jsonl,hf},kaggle,external,archive},resources/agent_knowledge,docs,config}
```

### Step 2: Copy Bible Sources
```bash
cp -r /path/to/zolai/Documents/Projects/bibles/* /path/to/zolai/data/raw/bibles/
```

### Step 3: Copy Kaggle Data
```bash
cp -r /path/to/zolai/Downloads/Kaggle/data/zolai_bible_dataset/* /path/to/zolai/data/processed/bible/
cp -r /path/to/zolai/Downloads/Kaggle/data/zolai-focused/* /path/to/zolai/data/processed/corpus/
cp -r /path/to/zolai/Downloads/Kaggle/data/processed/* /path/to/zolai/data/processed/
cp -r /path/to/zolai/Downloads/Kaggle/data/Zolai\ Lessons/* /path/to/zolai/data/external/lessons/
```

### Step 4: Copy Toolkit Code
```bash
cp -r /path/to/zolai-toolkit/src/zolai_toolkit/* /path/to/zolai/src/zolai/
```

### Step 5: Copy Kaggle Code
```bash
cp /path/to/zolai/Downloads/Kaggle/notebooks/*.ipynb /path/to/zolai/notebooks/
cp /path/to/zolai/Downloads/Kaggle/scripts/*.py /path/to/zolai/scripts/
cp /path/to/zolai/Downloads/Kaggle/resources/* /path/to/zolai/resources/
cp -r /path/to/zolai/Downloads/Kaggle/resources/agent_knowledge/* /path/to/zolai/resources/agent_knowledge/
```
...
ln -s /path/to/zolai /path/to/zolai/Downloads/Kaggle
ln -s /path/to/zolai/data/raw/bibles /path/to/zolai/Documents/Projects/bibles
```
