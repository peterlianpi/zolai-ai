...
**Example:** Abraham’ zineu Keturah’ tapate:
...
### sanggamnu = sister
**Context:** Used to denote a female sibling.
**Example:** tua ciangin Lotan’ sanggamnu in Timna ahi hi.
...
**Example:** Israelte tungah kumpi khatpeuh peuh in a uk ma-in
...
**Example:** Bela a sih ciangin ama tangin Bozrah khuami Zerah’ tapa Jobab in uk hi.
...
- **suan leh khakte** = sons and posterity/offspring
  - Usage: A comprehensive term for descendants, often used in genealogical contexts.

- **a uk ma-in** = before [someone] reigned
  - Usage: Used to establish a chronological sequence, indicating what happened prior to a specific reign.

- **ama tangin** = in his stead/place
  - Usage: Used specifically in the context of succession after death.
