...
### beh lutangte = heads of the clan/family/house
**Context:** Refers to the leaders or chief men of a lineage or tribe.
**Example:** Hihte khempeuh in Asher’ suan, beh lutangte a kipakta,

### kipakta = choice/selected/chief
**Context:** Used as an adjective describing the 'beh lutangte' (heads of house), implying they were the best or principal ones.
**Example:** Hihte khempeuh in Asher’ suan, beh lutangte a kipakta,
...
**Example:** Gal sungah nasem dingin khangsimna ah a kiciamteh

### kiciamteh = recorded/numbered/registered
**Context:** Refers to being officially counted in the genealogy/census.
**Example:** khangsimna ah a kiciamteh amau a phazah in

### phazah = number/count
**Context:** Used here to mean the total count of people.
**Example:** amau a phazah in mihing tul sawmnih leh tulguk ahi hi.

### tacil = firstborn
**Context:** Used to denote the first son born.
**Example:** Benjamin in a tacil Bela,

### nihna = second
**Context:** Ordinal number indicating the second position.
**Example:** a nihna Ashbel,

### thumna = third
**Context:** Ordinal number indicating the third position.
**Example:** a thumna Aharah,

### lina = fourth
**Context:** Ordinal number indicating the fourth position.
**Example:** a lina Nohah,

### ngana = fifth
**Context:** Ordinal number indicating the fifth position.
**Example:** leh a ngana Rafa-te’ pa ahi hi.
...
**Example:** amaute Mnanhath-ah galmatin kipua hi):

## Phrases & Usage

- **leh a sanggamnu uh** = and their sister
  - Usage: Used to introduce a female sibling in a list of offspring.

- **a kipakta, a thahat galhangte, uliante a ukte** = the choice ones, the mighty men of valour, the rulers of the princes
  - Usage: A descriptive phrase emphasizing the high status and capability of the listed individuals (Asher's descendants).

- **Gal sungah nasem dingin** = For service in war
  - Usage: Specifies the military purpose for which the census count was taken.
