...
### sawm-nih-le-khatna = twenty-first
**Context:** Used to denote the twenty-first position in a sequence (of names/divisions).
**Example:** a sawm-nih-le-khatna Jakhin tung

### sawmnih-le-nihna = twenty-second
**Context:** Used to denote the twenty-second position in a sequence.
**Example:** a sawmnih-le-nihna Gamul tung

### sawmnih-le-thumna = twenty-third
**Context:** Used to denote the twenty-third position in a sequence.
**Example:** a sawmnih-le-thumna Delaiah tung

### sawmnih-le-lina = twenty-fourth
**Context:** Used to denote the twenty-fourth position in a sequence.
**Example:** a sawmnih-le-lina Ma-aziah tungah tu hi.

### thupiak = commandment/ordinance
**Context:** Referring to what God commanded.
**Example:** Israel’ Topa Pasian in amah a thupiak bangin
...
**Example:** a kipsakna ngeina bangin
...
**Example:** Levi’ suante a om laite lakah

### sung panin = from among/out of the line of
**Context:** Indicates selection from within a specific lineage.
**Example:** Amram’ suante sung panin Shubael’ suante Jehdeiah ahi hi.

### ukpi = first/chief
**Context:** Used to denote the firstborn or chief among a group of brothers/descendants.
**Example:** Jeriah a ukpi

### sanggampa = brother (male sibling)
**Context:** Used here to mean 'brother' in the sense of a relative within the same lineage group (Michah's brother).
**Example:** Mikah’ sanggampa in Isshiah ahi hi.
...
**Example:** a beh tawh kizui-in

### siampite = priests
**Context:** Refers to the priestly class.
**Example:** Zadok, Ahimelek, leh siampite

### beh lutangte = chiefs of the families/heads of the houses
**Context:** Leaders of the various family lines.
**Example:** Levi mi beh lutangte’ muhna ah
...
- **a [number]-na [Name] tung**
  - Structure for listing sequential assignments (e.g., the 21st person goes to Jakhin). 'a' marks the ordinal, '-na' is the suffix for ordinal numbers, and 'tung' means 'to/unto'.
  - Example: a sawmnih-le-khatna Jakhin tung

- **[Ancestor]' suante sung panin [Descendant] ahi hi.**
  - Structure used to trace lineage by selection: 'From among the sons of [Ancestor], [Descendant] is the one.' 'sung panin' emphasizes selection from within the group.
  - Example: Amram’ suante sung panin Shubael’ suante Jehdeiah ahi hi.

- **[Name] a ukpi, [Name] a nihna, [Name] a thumna...**
