...
add("What is the critical rule for negative conditionals in Zolai?",
    "", "NEVER use 'lo leh' for negative conditionals. Always use 'kei a leh' or 'kei leh'. Wrong: 'Nong pai lo leh...' Correct: 'Nong pai kei a leh...' (If you do not go...) This is a Zolai Standard absolute rule.", "grammar")
