...
async def fix_zvs(client: GeminiClient, sentence: str):
    prompt = (
        "Fix this Zolai sentence to Zolai Standard. "
        "Replace: pasian→Pasian, ram→gam, tapa→tapa, topa→topa, kumpipa→kumpipa. "
...
if __name__ == "__main__":
    ...
    parser.add_argument("--zvs", type=str, help="Zolai sentence to fix to Zolai Standard")
