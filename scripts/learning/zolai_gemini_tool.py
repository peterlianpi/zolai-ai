#!/usr/bin/env python3
"""
Zolai Gemini Tool: Zolai Standard-compliant Tedim Zolai validator & dataset builder.
...
# ── Zolai Standard system prompt ────────────────────────────────────────────────────
SYSTEM_PROMPT = """You are a Tedim Zolai (Chin) linguistics expert following Zolai Standard.
...
Quality: 'high' = fully Zolai Standard; 'medium' = minor issues; 'low' = non-Tedim words or severe errors.
"""

VERIFY_PROMPT = """You are a strict Tedim Zolai (Chin) linguistics expert enforcing Zolai Standard.

Zolai Standard RULES:
...
4. NEGATION: 'kei' for conditionals, 'lo' for simple negatives
5. WORD ORDER: SOV standard, with natural object-fronting also allowed
...
quality: high=Zolai Standard+semantic correct; medium=Zolai Standard words but grammar/semantic issues; low=forbidden words or severe errors"""
...
def main():
    parser = argparse.ArgumentParser(description="Zolai Gemini Tool — Zolai Standard validator")
