...
Zolai Standard rules: pasian/gam/tapa/tua. gik=heavy. aksi=star. sikha=ghost/spirit. singat=saw.
...
BENCH_TEXT = """Ka gam ah tui tampi om hi. Nu le pa in naupang te an piak uh hi.
