...
1. Forbidden words replaced (pasian→pasian, tapa→tapa, etc.)
...
{existing_count + 1}. **Forbidden word 'pasian'** → Use 'pasian' (Zolai Standard)
   - WRONG: `pasian in ka it hi.`
   - CORRECT: `Pasian in kei hong it hi.`
   - Evidence: Zolai Standard, Bible corpus analysis

{existing_count + 2}. **Forbidden word 'tapa'** → Use 'tapa' (Zolai Standard)
   - WRONG: `tapa in ka it hi.`
   - CORRECT: `Tapa in kei hong it hi.`
   - Evidence: Zolai Standard

{existing_count + 3}. **Forbidden word 'topa'** → Use 'topa' (Zolai Standard)
   - WRONG: `topa in ka it hi.`
   - CORRECT: `Topa in kei hong it hi.`
   - Evidence: Zolai Standard

{existing_count + 4}. **Forbidden word 'ram'** → Use 'gam' (Zolai Standard)
   - WRONG: `Ram in ka it hi.`
   - CORRECT: `Gam in kei hong it hi.`
   - Evidence: Zolai Standard

{existing_count + 5}. **Forbidden words 'tua/tua'** → Use 'tua' (Zolai Standard)
