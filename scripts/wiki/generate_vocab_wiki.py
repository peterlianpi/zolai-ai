...
> Language: Tedim Zolai (Zolai Standard)
...
Use Zolai Standard (pasian not pasian, kei for negation).
```
...
### Zolai Standard audit
```
Check this Zolai text for Zolai Standard compliance:
[TEXT]
Flag: pasian→pasian, sanggin→sanginn, ram→gam, lo in conditionals
```

### Batch translation
```
Translate these 10 sentences from English to Zolai (Zolai Standard):
1. [sentence]
2. [sentence]
...
```
