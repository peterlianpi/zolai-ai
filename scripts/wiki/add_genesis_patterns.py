...
NEW = [
    ...
    ("What does 'khua mial bikbek' mean in Zolai?", "",
     "'khua mial bikbek' = pitch dark / complete darkness. 'khua mial' = darkness, 'bikbek' = completely/utterly. Used in Genesis 1:2 (Tedim Zolai Standard): 'Tuipi tung tengah khua mial bikbek a...' (Darkness was completely upon the face of the deep.)", "grammar"),
]
