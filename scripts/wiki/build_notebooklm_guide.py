...
Zolai Standard rules, common phrases, culture, and dictionary samples.
...
1. **Zolai Standard only** — use `pasian` (not pasian), `gam` (not ram), `tua` (not tua/tua)
...
6. **`lo`** is valid Zolai Standard — not Hakha-only
