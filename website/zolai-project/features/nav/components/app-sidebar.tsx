...
import {
  ...
  ArrowLeftRight, Settings, Building2, Bell, Menu,
  AlertCircle, UserCog, BookOpen, BookMarked, Cpu, GraduationCap, Library, Search,
  Languages, MessagesSquare, Upload, Volume2, Shield, Brain, Layout,
} from "lucide-react";
...
const adminNavItems = [
  {
    ...
    items: [
      ...
      { title: "Comments",          url: "/admin/comments",     icon: MessagesSquare },
