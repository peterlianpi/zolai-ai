...
const learnItems = [
  { title: "Curriculum", url: "/curriculum", icon: GraduationCap, items: [{ title: "CEFR Levels", url: "/curriculum" }, { title: "Phonics", url: "/curriculum/phonics" }] },
  { title: "Lessons", url: "/learn", icon: BookOpen, items: [{ title: "Lesson Plans", url: "/learn" }] },
...
const accountItems = [
  ...
  {
    title: "Security", url: "/security/alerts", icon: Shield,
    items: [
      { title: "Alerts", url: "/security/alerts" },
      { title: "Devices", url: "/security/devices" },
...
const adminNavItems = [
  {
    ...
    items: [
      ...
      { title: "Posts & News",      url: "/admin/posts",        icon: FileText },
      { title: "Learning Resources", url: "/admin/resources",    icon: Library },
      { title: "Submissions",       url: "/admin/submissions",  icon: Upload },
      { title: "Wiki Entries",      url: "/admin/wiki",         icon: BookMarked },
      ...
      { title: "Layout Editor",     url: "/admin/layout-editor",icon: LayoutDashboard },
      { title: "Templates",         url: "/admin/templates",    icon: FileText },
      { title: "Newsletter",        url: "/admin/newsletter/campaigns", icon: MessagesSquare },
      { title: "Subscribers",       url: "/admin/newsletter/subscribers", icon: Users },
      ...
      { title: "DevOps",            url: "/admin/devops",       icon: Shield },
    ],
  },
];
