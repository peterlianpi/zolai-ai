...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "An AI-powered tutor that teaches Tedim Zolai using CEFR-aligned levels, Socratic questioning, and real-world conversational practice.",
  },
  {
    icon: Library,
...
export function AboutPage() {
  return (
    <main className="container mx-auto px-4 py-16 max-w-4xl">
      {/* Hero */}
      <div className="text-center mb-16 rounded-2xl bg-gradient-to-br from-red-950 via-red-900 to-rose-900 py-16 px-8">
        <div className="flex justify-center mb-4">
          <Brain className="h-12 w-12 text-red-200" />
        </div>
        <h1 className="text-4xl font-bold tracking-tight mb-4 text-white">Preserving the Zolai Language</h1>
