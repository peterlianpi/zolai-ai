    ...
    <div className="flex flex-col gap-20 py-16 px-4 max-w-5xl mx-auto">
      <section className="text-center flex flex-col items-center gap-6 py-20 px-4 bg-gradient-to-br from-red-950 via-red-900 to-rose-900 rounded-2xl">
        ...
        <div className="flex gap-4 mt-2">
          <Link href="/signup" className="rounded-md bg-white text-red-950 px-6 py-2.5 text-sm font-semibold hover:bg-red-50 transition-colors">
            Get Started
          </Link>
          <Link href="/tutor" className="rounded-md border border-red-400 text-white px-6 py-2.5 text-sm font-semibold hover:bg-red-900/50 transition-colors">
            Try the Tutor
          </Link>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <Link key={title} href={href} className="group rounded-xl border bg-card p-6 hover:border-red-400 hover:shadow-md hover:shadow-red-100 dark:hover:shadow-red-950 transition-all">
      ...
      <section className="text-center rounded-2xl bg-gradient-to-br from-red-950 via-red-900 to-rose-900 p-12 flex flex-col items-center gap-4">
        ...
        <Link href="/signup" className="rounded-md bg-white text-red-950 px-8 py-3 text-sm font-semibold hover:bg-red-50 transition-colors">
          Create an account
        </Link>
      </section>
    </div>
