...
export function Footer({ siteSettings = [] }: FooterProps) {
  ...
  const showSocial = getSetting("footer_show_social", "true") === "true";
  const showNewsletter = getSetting("footer_show_newsletter", "false") === "true";
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">{siteDescription}</p>
          </div>
