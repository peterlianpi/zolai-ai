...
export default async function GrammarPage({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Grammar Reference</h1>
        <p className="text-muted-foreground mt-2">{entries.length} entries covering phonology, morphology, syntax, and semantics</p>
      </div>
