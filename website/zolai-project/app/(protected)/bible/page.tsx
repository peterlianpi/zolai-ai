...
export default async function BiblePage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Bible Corpus</h1>
        <p className="text-muted-foreground mt-2">{books.length} books · {totalVerses.toLocaleString()} verses · TDB77 + TBR17 + Tedim 2010 + KJV parallel</p>
      </div>
      <div className="text-xs text-muted-foreground border rounded-lg px-3 py-2 bg-muted/40">
