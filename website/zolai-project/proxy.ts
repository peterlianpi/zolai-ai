...
export async function proxy(request: NextRequest) {
  ...
  // DISABLED: Middleware session check causes redirect loops
  // Page-level requireAuth() handles authentication properly
  // TODO: Fix hasValidSession() to work with Better Auth session format
